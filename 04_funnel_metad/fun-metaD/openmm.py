...
p1 = [1035,1049,1223,1237,1256,1272,2589,2603,2625]
p2 = [537,552,571,590,601,615,626,637,649,659,1272,1298,1305,1324,1331,1472,1491,1498,1904,2099,2134,2582,2589,2603,2625]
...
bias = 10.0
meta = Metadynamics(system, [proj, ext], 300.0*kelvin, 10.0, 1.5*kilojoules_per_mole, 1000, biasDir = '.', saveFrequency = 500)

# Define the integrator.
integrator = LangevinIntegrator(300.0*kelvin,
                                1/picosecond,
                                0.002*picoseconds)
...
# Add reporters.
simulation.reporters.append(DCDReporter('openmm.dcd', 500))
simulation.reporters.append(StateDataReporter('openmm.log',
                                              500,
                                              step=True,
                                              time=True,
                                              ...
                                              remainingTime=True,
                                              separator=' '))
simulation.reporters.append(CheckpointReporter('openmm.chk', 500))
...
steps = 500
cycles = 1
steps_per_cycle = int(500/cycles)

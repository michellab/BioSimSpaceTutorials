...
/usr/bin/python3 /export/users/finlayclark/restraint_comparison_mif/study/scripts/parselj.py freenrg-LJCOR-lam-0.000.dat freenrg-LJCOR-lam-1.000.dat > freenrg-LJCOR.dat

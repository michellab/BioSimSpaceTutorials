...
protein = BSS.IO.readMolecules(
    ["inputs/protein/protein.rst7", "inputs/protein/protein.prm7"]
)[0]
...
lig_p_solvated = BSS.IO.readMolecules(
    [f"{tmp_dir}/{lig_name}_lig_s.prm7", f"{tmp_dir}/{lig_name}_lig_s.rst7"]
)
system_solvated = BSS.IO.readMolecules(
    [f"{tmp_dir}/{lig_name}_sys_s.prm7", f"{tmp_dir}/{lig_name}_sys_s.rst7"]
)
...
BSS.IO.saveMolecules(
    f"prep/ligands/{lig_name}_lig_equil_solv", lig_equil_fin, ["PRM7", "RST7"]
)

print("\n Ligand + protein:")
print(sys_equil_fin)
BSS.IO.saveMolecules(
    f"prep/protein/{lig_name}_sys_equil_solv", sys_equil_fin, ["PRM7", "RST7"]
)

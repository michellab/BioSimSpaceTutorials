...
class FreeEnergyPlotter(object):
    ...
    def plot_scatter_plot(
        self,
        xlabel=r"experimental $\Delta \Delta G$ in [kcal/mol]",
        ylabel=r"computed $\Delta \Delta G$ in [kcal/mol]",
    ...
    def plot_DGs(
        self, method_name="", target_name="", title="", filename=None, **kwargs
    ):
        self._plot_master_plot(
            self.dataseries1[:, 0],
            self.dataseries2[:, 0],
            xerr=self.dataseries1[:, 1],
            yerr=self.dataseries2[:, 1],
            filename=filename,
            title=title,
    ...
    def _plot_bar_plot_no_dic_graph2(self, r1_weight, r2_weight, r3_weight, keys):
        ...
        rects2 = ax.bar(
            ...
            error_kw={"ecolor": "black", "linewidth": 2},  # error-bars colour
        )
        rects3 = ax.bar(
            ind + 2 * width,
            data2,

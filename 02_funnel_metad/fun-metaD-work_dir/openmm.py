...
p1 = [1223,1237,1256,2589,2603,2625,2641]
p2 = [537,552,571,590,601,615,626,637,649,659,1272,1298,1305,1324,1331,1406,1472,1491,1498,1897,1904,1924,2099,2134,2582,2589,2603,2625]
...
bias = 10.0
meta = Metadynamics(system, [proj, ext], 300.0*kelvin, 10.0, 1.5*kilojoules_per_mole, 1000, biasDir = '.', saveFrequency = 1000)
...
# Add reporters.
simulation.reporters.append(DCDReporter('openmm.dcd', 1000))
